...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/product-margin-script.js"></script>
	</head>	
									...
									<table id="dynamic-table" class="table table-bordered table-striped table-condensed cf"  datatable="ng" dt-options="vm.dtOptions">
										...
										<tbody >
											<tr  ng-repeat="cat in pagedItems">
												...
												<td data-title="Sales Price">{{cat.SalesPrice | number:2}}
												</td>
												<td data-title="Cost Price">{{cat.PurchasePrice | number:2}}</td>
												
												<td data-title="Margin">{{cat.Margin | number:2	}}</td>
