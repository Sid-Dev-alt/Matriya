...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/package-script.js"></script>
	</head>	

	<body class="no-skin" data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" data-ng-init="GetOrder(<?php echo $OrderPkId;?>)">
										...
										<tbody >
											<tr  ng-repeat="cat in pagedItems">
												...
												<td data-title="Package Status">
													<div ng-if="cat.PackageStatus=='1'">
														Not shipped
														<a href="shipping.php?Id={{cat.PkId}}"><span class="label label-info arrowed-right arrowed-in" ng-click="SetasShip()">Change to Shipped</span></a>
													</div>
								...
								<!-- PAGE CONTENT BEGINS -->
								 <form class="form-horizontal" role="form" id="AddCategoryForm" name="AddCategoryForm" autocomplete="off" enctype="multipart/form-data" novalidate="" data-ng-submit="AddCategoryData()">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<select type="text" id="OrderPkId" placeholder="" class="form-control" name="OrderPkId" required  data-ng-model="OrderPkId" ng-change="GetOrderInfo(OrderPkId)" convert-to-number>
												<option value="">Select</option>
												<option ng-repeat="ordr in OrderArr" value="{{ordr.PkId}}">{{ordr.OrderId}}</option>
											</select>
									...
									<tbody>
										<tr ng-repeat="bat in BatchArr">
											...
											<div class="form-group">
												<div class="col-sm-12">
													<input type="hidden" value="{{bat.SalePkId}}">
												{{bat.product}}
