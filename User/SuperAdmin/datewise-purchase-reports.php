...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/datewise-purchasereports-script.js"></script>
	</head>
							...
							<div class="row">
								<div class="col-xs-12 page-header">
			                  	 <div class="col-xs-8 col-sm-8 col-lg-9">
			                  	 	<div class="" >
										<h1>Datewise Purchase Report</h1>
										</div>
			<!-- /.page-header --></div>
				              </div>							
							</div>
								...
								<div class="col-xs-12">
									...
									<div class="row">
										...
										<div class="row">
											...
											<a href="download-dtwise-purchasereport.php?FromDate={{fromdate | date}}&ToDate={{todate | date}}" target="_self" class="btn btn-success" > Download</a>
											</div>
										</div>
										...
										<table id="dynamic-table" class="table table-bordered table-striped table-condensed cf" >
											...
											<tbody >
												...
												<tr dir-paginate="cat in pagedItems|orderBy:sortKey:reverse|filter:search|itemsPerPage:10" total-items="{{total_count}}" current-page="mypageno">
													...
													<td data-title="Item Name">{{cat.Micron}} {{cat.ProductName}} {{cat.ProductSize}} MM</td>
													...
													<td data-title="Remarks"> <p class="pre-data">{{cat.Comments}}</p></td>
												</tr>
