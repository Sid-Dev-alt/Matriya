...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/add-supplier-script.js"></script>
	</head>

	<body class="no-skin"  data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" ng-init="GetCustomerId();GetSalutes();GetPaymentTerms();">
