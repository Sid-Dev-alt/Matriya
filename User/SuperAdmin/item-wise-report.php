...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/item-wise-report-script.js"></script>
	</head>
								...
								<div class="col-xs-12">
									...
									<div class="dataTables_wrapper form-inline no-footer" ng-if="pagedItems.length!='0'">
										...
										<div class="row">
											...
											<div class="col-xs-3">
												<h4 class="pull-right">TotalQty: {{TotalQty | number:3}} kg</h4>
											</div>
											<!-- <div class="col-xs-6">
										...
										<table id="dynamic-table" class="table table-bordered table-striped table-condensed cf" >
											<thead class="cf">
												<tr>
													...
													<th ng-click="sort('Qty')">Qty <span class="glyphicon sort-icon" ng-show="sortKey=='Qty'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span></th>
											...
											<tfoot>
												...
												<td><span id="totalSum" ng-model="sum" ng-show="span1" ng-bind="calculateSum()"></span><b>{{sum ? sum : 0 | number:3}} kg</b></td>
											</tr> -->
											</tfoot>
										</table>
									</div>
