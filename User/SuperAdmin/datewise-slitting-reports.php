...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/datewise-slitreports-script.js"></script>
	</head>
								...
								<div class="col-xs-12">
									...
									<div class="row">
										...
										<div class="row">
											...
											<a href="download-dtwise-slitreport.php?FromDate={{fromdate | date}}&ToDate={{todate | date}}" target="_self" class="btn btn-success" > Download</a>
											</div>
										</div>
										...
										<table id="dynamic-table" class="table table-bordered table-striped table-condensed cf" >
											<thead class="cf">
												<tr>
													...
													<!-- <th>GoDown</th> -->
													<th  ng-click="sort('From')">From Item <span class="glyphicon sort-icon" ng-show="sortKey=='From'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span></th>
													...
													<th  ng-click="sort('Cutting')">Cutting Details <span class="glyphicon sort-icon" ng-show="sortKey=='Cutting'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span></th>
												</tr>
											</thead>										
											<tbody >
												...
												<tr dir-paginate="cat in pagedItems|orderBy:sortKey:reverse|filter:search|itemsPerPage:10" total-items="{{total_count}}" current-page="mypageno">
													...
													<td data-title="From Item">{{cat.Micron}} {{cat.ProductName}} {{cat.ProductSize}} MM</td>
													
													<td data-title="Roll No"><a href="" ng-click="GetRollData(cat.UniqueRollNo)">{{cat.UniqueRollNo}}</a></td>
													<td data-title="Remarks">{{cat.DetailRemarks}}</td>
													<td data-title="Slitting Details">
														<table id="dynamic-table" class="table table-bordered table-striped table-condensed cf" >
														<thead>
															<th>Item</th>
															<th>Roll No</th>
													...
													<tr ng-repeat="sp in cat.data2">
														...
														<td><a href="" ng-click="GetRollDataDetail(sp.RollNo)">{{sp.RollNo}}</a></td>
														<td>
