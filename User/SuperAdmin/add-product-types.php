...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/add-product-type-script.js"></script>
	</head>

	<body class="no-skin" data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" data-ng-init="GetProductId();LoadCatgory();GetUnits()">
