...
<script src="http://cdn.zingchart.com/angular/zingchart-angularjs.js"></script> -->
	...
	<body class="no-skin" data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" ng-init="GetSalesData();GetMonthOrder();GetMonthtopsales();GetMonthtopCustomers()">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content" id="no-more-tables">
						...
						<div class="row">
							<div class="col-sm-3">
							<div class="infobox infobox-pink infobox-lg infobox-dark">
									<div class="infobox-progress">
										<div class="easy-pie-chart percentage" data-percent="61" data-size="39" >
											<span class="percent" style="font-size: 30px;">{{remainpkdqty}}</span>
										<canvas height="39" width="39"></canvas></div>
									</div>

									<div class="infobox-data">
										<div class="infobox-content">To be Packed</div>
									</div>
								</div>
							</div>
							 <div class="col-sm-3">
							<div class="infobox infobox-blue infobox-lg infobox-dark">
									<div class="infobox-progress">
										<div class="easy-pie-chart percentage" data-percent="61" data-size="39" >
											<span class="percent" style="font-size: 30px;">{{TobeShippd}}</span>
										<canvas height="39" width="39"></canvas></div>
									</div>

									<div class="infobox-data">
										<div class="infobox-content">To be Shipped</div>
									
									</div>
								</div>
							</div>
							<div class="col-sm-3">
							<div class="infobox infobox-orange infobox-lg infobox-dark">
									<div class="infobox-progress">
										<div class="easy-pie-chart percentage" data-percent="61" data-size="39" >
											<span class="percent" style="font-size: 30px;">{{TobeDeliver}}</span>
										<canvas height="39" width="39"></canvas></div>
									</div>

									<div class="infobox-data">
										<div class="infobox-content">To be Delivered</div>
									</div>
								</div>
							</div>	
							<div class="col-sm-3">
							<div class="infobox infobox-red infobox-lg infobox-dark">
									<div class="infobox-progress">
										<div class="easy-pie-chart percentage" data-percent="61" data-size="39" >
											<span class="percent" style="font-size: 30px;">{{TobeInvoice}}</span>
										<canvas height="39" width="39"></canvas></div>
									</div>

									<div class="infobox-data">
										<div class="infobox-content">To be Invoiced</div>
									</div>
								</div>
							</div>	 
						</div>
						...
						<div class="row">
							<div class="col-sm-3">
							<div class="infobox infobox-grey infobox-lg infobox-dark">
									<div class="infobox-progress">
										<div class="easy-pie-chart percentage" data-percent="61" data-size="39" >
											<span class="percent" style="font-size: 30px;">{{PartialInvoice}}</span>
										<canvas height="39" width="39"></canvas></div>
									</div>

									<div class="infobox-data">
										<div class="infobox-content">Partially Invoiced</div>
									</div>
								</div>
							</div>
							<div class="col-sm-3">
							<div class="infobox infobox-green infobox-lg infobox-dark">
									<div class="infobox-progress">
										<div class="easy-pie-chart percentage" data-percent="61" data-size="39" >
											<span class="percent" style="font-size: 30px;">{{Invoiced}}</span>
										<canvas height="39" width="39"></canvas></div>
									</div>

									<div class="infobox-data">
										<div class="infobox-content">Total Invoiced</div>
									</div>
								</div>
							</div>
						</div>
