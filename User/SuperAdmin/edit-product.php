...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/edit-product-type-script.js"></script>
	</head>

	<body class="no-skin" data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" data-ng-init="GetListData(<?php echo $ProductPkId;?>)">
		...
		<!-- /.page-header --></div>
									...
									<table id="dynamic-table" class="table table-bordered table-striped table-condensed cf"  datatable="ng" dt-options="vm.dtOptions">
										...
										<tbody >
											<tr  ng-repeat="cat in pagedItems">
												...
												<!-- <td data-title="Product Id">{{cat.ProductId}}</td> -->
												...
												<td data-title="Available Qty">{{cat.AvlQty}}</td>
												<td data-title="Status">{{cat.displaystatus}}</td>
												<td data-title="Action">
													<button type="button" class="btn btn-xs btn-info" data-ng-click="EditCat(cat.PkId,cat.ProductId,cat.ProductName,cat.PkId_SubCategoryMaster,cat.PkId_Level2SubCategoryMaster,cat.PkId_Level3SubCategoryMaster,cat.ProductDescription,cat.PkId_Category,cat.CategoryName,cat.FileName,cat.UploadFile1,cat.UploadFile2,cat.UploadFile3,cat.UploadFile4,cat.UploadFile5,cat.Status)">Edit &nbsp;
					...
					<div ng-show="FormAdd" >
						<div class="row">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								 <form class="form-horizontal" role="form" id="AddCategoryForm" name="AddCategoryForm" autocomplete="off" enctype="multipart/form-data" novalidate="" data-ng-submit="Updatedata()">
									...
									<div class="form-group" ng-if="SubCategoryArr.length!='0'">
										<label class="col-sm-3 control-label no-padding-right" for="categoryname">Sub Category </label>
										
										<div class="col-sm-6">
										<select type="text" id="subcategory" placeholder="" class="form-control" name="subcategory" data-ng-model="$parent.subcategory" ng-change="GetLevel2(category,subcategory)" convert-to-number>
											<option value="">Select</option>
									...
									<div class="form-group" ng-if="Level2Arr.length!='0'">
										<label class="col-sm-3 control-label no-padding-right" for="Level-2">Level-2 Sub Category </label>
										
										<div class="col-sm-6">
										<select type="text" id="lvl2subcat" placeholder="" class="form-control" name="lvl2subcat" data-ng-model="$parent.lvl2subcat" ng-change="GetLevel3(category,subcategory,lvl2subcat)" convert-to-number >
											<option value="">Select</option>
									...
									<div class="form-group" ng-if="Level3Arr.length!='0'">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" id="productname" placeholder="" class="form-control" name="productname" required  data-ng-model="productname" data-ng-minlength="3" value="">
											<small>Product name will be save as (ProductName-Size-Colour) format</small>
												<div class="error" data-ng-show="submitted || AddCategoryForm.productname.$dirty && AddCategoryForm.productname.$invalid">
													<small class="error" data-ng-show="AddCategoryForm.productname.$error.required">Product Name is required.</small>
													<small class="error" data-ng-show="AddCategoryForm.productname.$error.minlength">Product Name is required to be at least 3 characters</small>
													<small class="error" data-ng-show="AddCategoryForm.productname.$error.pattern">Product Name should be alphabets ex:abcd</small>
												</div>
										</div>
									</div>

									<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="product Size"> Size </label>
									
									<div class="col-sm-6">
										<select type="text"  id="productsize" placeholder="" class="form-control" name="productsize"  data-ng-model="productsize" >
											<option value="">Select</option>
									...
									<div class="clearfix"></div>
									 <div class="form-group">
									  	<label class="col-sm-3 control-label no-padding-right" for="PinCode">
									  		<span ng-if="FileName==''">Add</span>
									  		<span ng-if="FileName!=''">Replace</span>
									  		Display File
		                              	...
		                              	<div class="clearfix"></div>
		                              	<img width="150" height="150" ng-src="../ProductImages/{{FileName}}">
		                              	</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-6">
											<select class="form-control" name="unit" ng-model="unit">
												<option value="">Select</option>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="unit"> Product Cost Price <span class="error">*</span></label>
										<div class="col-sm-6">
											<input type="text" id="costprice" placeholder="" class="form-control" name="costprice" data-ng-model="costprice" maxlength="8" required="" class="form-control" valid-number allow-decimal="false" allow-negative="false">
												<div class="error" data-ng-show="submitted || AddCategoryForm.costprice.$dirty && AddCategoryForm.costprice.$invalid">
													<small class="error" data-ng-show="AddCategoryForm.costprice.$error.required">Product Cost Price is required.</small>
												</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="MPN"> MPN</label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="UPC"> UPC</label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="ISBN"> ISBN</label>
									...
									<!-- <div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" id="openstock" placeholder="" class="form-control" name="openstock" data-ng-model="openstock" maxlength="10" required="" class="form-control" number>
									...
									<!-- <div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" id="stockrate" placeholder="" class="form-control" name="stockrate" data-ng-model="stockrate" maxlength="8" valid-number="" allow-decimal="false" allow-negative="false" required="">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" id="reorderlevel" placeholder="" class="form-control" name="reorderlevel" data-ng-model="reorderlevel" maxlength="10" class="form-control" number>
...
<!-- <input type="text" value="{{oldiinvtrack}}">
									<div class="form-group">
									...
									<div id="no-more-tables" ng-if="invtrack=='Batch' && openstock!=null">
										...
										<tr ng-repeat="bat in BatchArr">
											...
											<div class="form-group">
												<div class="col-sm-12">
													...
													<input type="hidden" value="{{bat.AvlQuantity}}">
