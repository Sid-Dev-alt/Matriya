    	...
    	{	
    		while($row = $query->fetch())
    		{
    			...
    			while($row3 = $query3->fetch())
    			{
    				...
    				$data2[] = array('EntryPkId' => $EntryPkId,'ProductId_ProductMaster' => $ProductId_ProductMaster,'ProductName' => $ProductName,'TotalProductName' => $TotalProductName,'ProductSize' => $ProductSize,'Micron' => $Micron,'PurchaseQty' => $PurchaseQty,'Remarks' => $DetailRemarks,'RollNo' => $RollNo,'Unit' => $Unit,'IsSplitQty' => $IsSplitQty,'Isinvoiced' => $Isinvoiced,'DeleteStatus' => $DeleteStatus);
    			}
    			$data1[] = array('FormPkId' => $FormPkId,'RawPurchaseId' => $RawPurchaseId,'VendorId_VenodrMaster' => $VendorId_VenodrMaster,'VendorName' => $VendorName,'RawPODate' => $RawPODate,'PkId_GoDownMaster'=>$PkId_GoDownMaster,'GoDownName'=>$GoDownName,'Comments'=>$row['Comments'],'data2'=>$data2,);
    			unset($data2);
    		}
