		...
		{			
			...
			foreach ($EntryPkId as $key => $value) {				# code...
				...
				if($EntryPkId[$key]=="")
				{
					...
					$query13->execute(array($InvoiceId,$entrydate,$row11['PkId_Category'],$ProductId[$key],$product[$key],$InvPkId[$key],$AvlQty[$key],$DATEIME));
				...
				$Post = "Created Invoice with (Invoices (InvoiceId: $InvoiceId,CustomerId_CustomerMaster: $CustomerId,CustomerName: $customername,CustomerMobile: $customermobileno,CustomerPlace: $customerplace,Reference: $referencenum,InvoiceDate: $entrydate,CustomerNotes: $cnotes,InvoiceStatus: '2')) as on $DATEIME by $SAId";
				$Type="Invoice";		
