...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/search-slitting-script.js"></script>
    	<style type="text/css">
    		.new-row {
  clear: left;
}
	...
	<body class="no-skin" data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" data-ng-init="LoadProducts()">
						...
						<div class="row" ng-show="FormList">
							<div class="col-md-12">
										<form class="form-horizontal" role="form" id="AddCategoryForm" name="AddCategoryForm" autocomplete="off" enctype="multipart/form-data" novalidate="">
													...
													<div class="form-group">
														...
														<div class="col-md-8">
															<select class="form-control" name="searchtype" ng-model="searchtype">
																...
																<option value="Slit Id">Slit Id</option>
											...
											<div class="row">
												<div class="col-md-6" ng-show="searchtype=='Slit Id'">
													<div class="form-group">
														<label class="col-sm-4 control-label no-padding-right" for="Slit Id"> Slit Id </label>
														
														<div class="col-sm-8">
															<input type="text" id="salesorder" placeholder="" class="form-control" name="searchslitid" required  data-ng-model="searchslitid">
																<div class="error" data-ng-show="submitted || AddCategoryForm.searchslitid.$dirty && AddCategoryForm.searchslitid.$invalid">
																	<small class="error" data-ng-show="AddCategoryForm.searchslitid.$error.required">Slit Id is required.</small>
																</div>
														</div>
													</div>
												</div>
												...
												<div class="col-md-6" ng-show="searchtype=='From & To Date'">
													<div class="form-group">
														<label class="col-sm-4 control-label no-padding-right" for="Slit From Dt"> Slit From Dt </label>
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="searchfromdate"  placeholder="" id="searchfromdate" ng-model="searchfromdate" uib-datepicker-popup="dd-MMM-yyyy" is-open="opened.opened2" ng-click="doubleopen($event,'opened2')"  datepicker-options="assDate1" required="" > 
																<div class="error" data-ng-show="submitted || AddCategoryForm.searchfromdate.$dirty && AddCategoryForm.searchfromdate.$invalid">
																	<small class="error" data-ng-show="AddCategoryForm.searchfromdate.$error.required">PO From Date is required.</small>
																</div>
														</div>
													</div>
												</div>
												...
												<div class="col-md-6" ng-show="searchtype=='From & To Date'">
													<div class="form-group">
														<label class="col-sm-4 control-label no-padding-right" for="Slit To Dt"> Slit To Dt</label>
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="searchtodate"  placeholder="" id="searchtodate" ng-model="searchtodate" uib-datepicker-popup="dd-MMM-yyyy" is-open="opened.opened3" ng-click="tribleopen($event,'opened3')"  datepicker-options="assDate2" required="" > 
																<div class="error" data-ng-show="submitted || AddCategoryForm.searchtodate.$dirty && AddCategoryForm.searchtodate.$invalid">
																	<small class="error" data-ng-show="AddCategoryForm.searchtodate.$error.required">PO To Date is required.</small>
																</div>
														</div>
													</div>
												</div>
											...
											<div class="row"> -->
												<div class="col-sm-6" ng-show="searchtype=='Item Name'">
													<label class="col-sm-4 control-label no-padding-right" for="Item Name"> Item Name </label>
													<div class="col-md-8">
														<ui-select ng-model="$parent.itemname" theme="selectize" title="Choose a person">
												    			...
												    			<ui-select-choices   repeat="item in ProductArr | filter: $select.search">
    									...
    									<tbody>
    										<tr dir-paginate="cat in pagedItems|orderBy:sortKey:reverse|filter:search|itemsPerPage:5" total-items="{{total_count}}" current-page="mypageno">
												...
												<td data-title="Action">
													...
													<a ng-if="cat.delbtn==0" href="" ng-click="DeleteOrder(cat.FormPkId,cat.SlitId,cat.PkId_RawPurchaseMasterDetails,cat.PkId_InventoryMaster,cat.UniqueRollNo,cat.PurchaseQty)"  class="btn btn-xs btn-danger">Delete &nbsp;
