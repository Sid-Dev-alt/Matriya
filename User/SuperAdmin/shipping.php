...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/shipping-script.js"></script>
	</head>	

	<body class="no-skin" data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" data-ng-init="GetPkg(<?php echo $PkgPkId;?>)">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								 <form class="form-horizontal" role="form" id="AddCategoryForm" name="AddCategoryForm" autocomplete="off" enctype="multipart/form-data" novalidate="" data-ng-submit="AddCategoryData()">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="Product Id"> Invoice Id <span class="error">*</span></label>
										...
										<div class="col-sm-6">
											<input type="text" id="InvoiceId" placeholder="" class="form-control" name="InvoiceId" required  data-ng-model="InvoiceId" disabled="">
												<div class="error" data-ng-show="submitted || AddCategoryForm.InvoiceId.$dirty && AddCategoryForm.InvoiceId.$invalid">
													<small class="error" data-ng-show="AddCategoryForm.PackageId.$error.required">Invoice Id is required.</small>
												</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="Choose ">Mode of Transport <span class="error">*</span></label>
										<div class="col-sm-6">
											<div class="control-group">
												<div class="radio">
													<label>
														<input name="transporttype" ng-model="transporttype" type="radio" class="ace" ng-required="!transport" value="Self">
														<span class="lbl"> Self</span>
													</label>
												</div>
												<div class="radio">
													<label>
														<input name="transporttype" ng-model="transporttype" type="radio" class="ace" ng-required="!transporttype" value="External">
														<span class="lbl"> External</span>
													</label>
												</div>
											</div>
											<div class="error" data-ng-show="submitted || AddCategoryForm.transporttype.$dirty && AddCategoryForm.transporttype.$invalid">
												<small class="error" data-ng-show="AddCategoryForm.transporttype.$error.required"> is required.</small>
											</div>
										</div>
									</div>

									<div class="form-group" ng-if="transporttype=='External'">
										<label class="col-sm-3 control-label no-padding-right" for="reason">Carrier / Transport <span class="error">*</span></label>

										<div class="col-sm-6">
										<input type="text" class="form-control" name="carrier"  placeholder="" id="carrier" ng-model="$parent.carrier" required="" uib-typeahead="cat as cat for cat in TransportsArr | filter:$viewValue"  > 
									...
									<div class="form-group" ng-if="transporttype=='External'">
										<label class="col-sm-3 control-label no-padding-right" for="reason">Transport Invoice No <span class="error">*</span></label>

										<div class="col-sm-6">
										<input type="text" class="form-control" name="transportinvoiceno"  placeholder="" id="transportinvoiceno" ng-model="$parent.transportinvoiceno" required="" > 
											<div class="error" data-ng-show="submitted || AddCategoryForm.transportinvoiceno.$dirty && AddCategoryForm.transportinvoiceno.$invalid">
												<small class="error" data-ng-show="AddCategoryForm.transportinvoiceno.$error.required">Transport Invoice No is required.</small>
											</div>
										</div>
									</div>
									...
									<div class="form-group" ng-if="transporttype=='External'">
										...
										<div class="col-sm-6">
										<input type="text" id="shipcharge" placeholder="" class="form-control" name="shipcharge" data-ng-model="$parent.shipcharge" maxlength="8" valid-number="" allow-decimal="false" allow-negative="false" required="">
										<div class="error" data-ng-show="submitted || AddCategoryForm.shipcharge.$dirty &amp;&amp; AddCategoryForm.shipcharge.$invalid">
											<small class="error" data-ng-show="AddCategoryForm.shipcharge.$error.required">Shipping Charges is required.</small>
										</div>
										</div>
									</div>
