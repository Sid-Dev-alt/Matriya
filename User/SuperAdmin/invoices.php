...
<html lang="en">
	...
	<body class="no-skin" data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" >
		...
		{
		?>
		<div data-ng-init="GetOrder(<?php echo $OrderPkId;?>)"></div>
		<?php	
		}
		else
		{
										...
										<tbody >
											<tr  ng-repeat="cat in pagedItems">
												...
												<td data-title="Action">
													<button type="button" class="btn btn-xs btn-inverse" data-ng-click="ViewInvoice(cat.PkId,cat.InvoiceId,cat.InvoiceDate,cat.DueDate,cat.CustomerName,cat.CEmailId,cat.CMobile,cat.SubTotal,cat.GST,cat.GSTAmount,cat.AdditionalCharges,cat.DiscountAmount,cat.InvoiceTotal,cat.data2)">View &nbsp;
														<i class="ace-icon fa fa-eye bigger-120"></i>
													</button>&nbsp;
													<button type="button" class="btn btn-xs btn-danger" data-ng-click="Delete(cat.PkId,cat.InvoiceId,cat.InvoiceDate)">Delete &nbsp;
					...
					<div ng-show="FormAdd" >
						<div class="row">
										...
										<div class="col-sm-6">
											<input type="text" id="InvoiceId" placeholder="" class="form-control" name="InvoiceId" required  data-ng-model="InvoiceId" disabled="">
												<div class="error" data-ng-show="submitted || AddCategoryForm.InvoiceId.$dirty && AddCategoryForm.InvoiceId.$invalid">
													<small class="error" data-ng-show="AddCategoryForm.InvoiceId.$error.required">Invoice Id is required.</small>
												</div>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="Product Id"> Order Number <span class="error">*</span></label>
										
										<div class="col-sm-6">
											<input type="text" id="OrderId" placeholder="" class="form-control" name="OrderId" required  data-ng-model="OrderId" ng-disabled="FormPkId!=undefined">
									...
									<tbody>
										<tr ng-repeat="bat in BatchArr">
											...
											<div class="form-group">
												...
												<p ng-if="bat.ProductId!=undefined">Available Quantity: {{bat.AvlQty}}<br>
													<small class="error" ng-if="bat.AvlQty=='0'">Quantiy not available</small>
											...
											<td data-title="Invoiced Qty" class="center">Qty Invoiced: {{bat.InvoicedQty}} <br>Qty to be Invoice: {{bat.OrderQuantity-bat.InvoicedQty}}</td>	
											<td data-title="Qty" class="center">
												<div class="form-group">
												<div class="col-sm-12">
												<input type="text" id="quantity" placeholder="" class="form-control" name="quantity{{$index}}" data-ng-model="bat.quantity" maxlength="10" class="form-control" number ng-change="ChkQty(bat.AvlQty,bat.InvoicedQty,bat.quantity,bat.OrderQuantity,$index)">
												
												<!-- ng-change="ChkQty(bat.AvlQty,bat.quantity,bat.OrderQuantity,$index)" -->
													...
													<div class="clearfix"></div>
													<small class="error">{{bat.OrderQtyErr}}</small>
													<div class="clearfix"></div>
													<small class="error">{{bat.RemainQtyErr}}</small>
												</div>
												<div class="clearfix">&nbsp;</div>
													...
													<div class="modal-dialog  modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																...
																<div class="pull-left">
																	<h4>{{bat.product}}</h4>
																	<p>Selected Quantity: {{bat.quantity || 0}}</p>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">&nbsp;</div>
								<div class="col-sm-2">
									<input  type="text" name="additionalcharges" class="form-control decimaltemp"  ng-model="additionalcharges" valid-number="" allow-decimal="false" allow-negative="false" ng-change="getDiscAmt(sum,disctype,discvalue,additionalcharges,gstperc)">	
							...
							<div class="form-group">
								...
								<div class="col-sm-1">
									<input  type="text" name="discvalue" class="form-control decimaltemp"  ng-model="discvalue" valid-number="" allow-decimal="false" allow-negative="false" ng-change="getDiscAmt(sum,disctype,discvalue,additionalcharges,gstperc)">	
