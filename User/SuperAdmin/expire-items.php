...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/expire-item-script.js"></script>
	</head>	
									...
									<table id="dynamic-table" class="table table-bordered table-striped table-condensed cf"  datatable="ng" dt-options="vm.dtOptions">
										...
										<tbody >
											<tr  ng-repeat="cat in pagedItems">
												...
												<td data-title="Product Name">{{cat.ProductName}}
												</td>
												<td data-title="Batch / Serial No">{{cat.BatchNoORSrNo}}
												</td>
												<td data-title="Batch Manufacturer">{{cat.BatchManufacturer}}</td>
												
												<td data-title="Manfacture Date">{{cat.ManfactureDate}}</td>
												<td data-title="Expire Date">{{cat.ExpireDate}}</td>
												<td data-title="Quantity">{{cat.Quantity}}</td>
