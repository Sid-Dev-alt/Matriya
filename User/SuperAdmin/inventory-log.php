...
<html lang="en">
    ...
    <script src="angularjs/Inventory-log-script.js"></script>
					...
					<div class="row">
								...
								<div class="dataTables_wrapper form-inline no-footer" ng-if="ProductArray.length!='0'">
									<table  id="dynamic-table"  class="table table-bordered table-striped table-condensed cf" datatable="ng" dt-options="vm.dtOptions">
										...
										<tbody >
											<tr ng-repeat="sup in ProductArray | orderBy: 'PkId'" >
												...
												<td data-title="Detail">{{sup.action}}
													<p>{{sup.CreatedTime | date}}</p>
												</td>
							...
							<table class="table table-bordered table-striped table-condensed cf"   >
								...
								<tbody >
									<tr ng-repeat="trsfr in TransferArray" ng-if="$index>=0" >
										...
										<td>
											<button type="button" class="btn btn-block btn-danger " ng-click="DeleteEntry($index)">Remove</button>
										</td>
									</tr>
								</tbody>
							</table>
