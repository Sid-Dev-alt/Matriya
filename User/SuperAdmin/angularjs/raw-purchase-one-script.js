...
$scope.getData = function(pageno){ 
    ...
    // This would fetch the data on page change.
        ...
        $http.post("load-raw-purchase-one.php",{'itemsPerPage': $scope.itemsPerPage, 'pagenumber': pageno, 'searchpro': $scope.searchpro})
          .then(function successCallback(response)
        {
            var data = response.data;
...
$scope.AddCategoryData = function ()
{
	...
	{
		window.location.href = "list-raw-purchase.php";
	}
