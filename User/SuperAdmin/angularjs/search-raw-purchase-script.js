...
$scope.getData = function(pageno){ 
    ...
    // This would fetch the data on page change.
        ...
        $http.post("load-search-raw-purchase.php",{'itemsPerPage': $scope.itemsPerPage, 'pagenumber': pageno,'searchpoid': $scope.searchpoid, 'searchfromdate': $scope.searchfromdate,'searchtodate':$scope.searchtodate,'itemname':$scope.itemname.ProductId,'searchtype':$scope.searchtype})
          .then(function successCallback(response)
        {
            var data = response.data;
