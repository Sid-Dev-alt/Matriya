...
$scope.GetVendors = function()
{
 ...
 $scope.loading = false;
    ...
    // This would fetch the data on page change.
        ...
        $http.post("load-search-invoices.php",{'itemsPerPage': $scope.itemsPerPage, 'pagenumber': pageno,'searchdisid': $scope.searchdisid, 'searchfromdate': $scope.searchfromdate,'searchtodate':$scope.searchtodate,'partyname':$scope.partyname.VendorId,'searchtype':$scope.searchtype})
          .then(function successCallback(response)
        {
            var data = response.data;
