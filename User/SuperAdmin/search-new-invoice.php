...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/search-new-invoice-script.js"></script>
	</head>

	<body class="no-skin" data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" ng-init="GetVendors()">
							...
							<div class="row" ng-show="FormList">
								<div class="col-md-12">
										<form class="form-horizontal" role="form" id="AddCategoryForm" name="AddCategoryForm" autocomplete="off" enctype="multipart/form-data" novalidate="">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label class="col-sm-4 control-label no-padding-right" for="Select Search Type"> Select Search Type </label>
														<div class="col-md-8">
															<select class="form-control" name="searchtype" ng-model="searchtype">
																<option value="">Select</option>
																<option value="Dispatch Id">Dispatch Id</option>
											...
											<div class="row">
												<div class="col-md-6" ng-show="searchtype=='Dispatch Id'">
													<div class="form-group">
														<label class="col-sm-4 control-label no-padding-right" for="Dispatch Id"> Dispatch Id </label>
														
														<div class="col-sm-8">
															<input type="text" id="salesorder" placeholder="" class="form-control" name="searchdisid" required  data-ng-model="searchdisid">
																<div class="error" data-ng-show="submitted || AddCategoryForm.searchdisid.$dirty && AddCategoryForm.searchdisid.$invalid">
																	<small class="error" data-ng-show="AddCategoryForm.searchdisid.$error.required">Dispatch Id is required.</small>
																</div>
														</div>
													</div>
												</div>
												
												<div class="col-md-6" ng-show="searchtype=='From & To Date'">
													<div class="form-group">
														<label class="col-sm-4 control-label no-padding-right" for="Dis From Dt"> Dis From Dt </label>
														
														<div class="col-sm-8">
															<input type="text" class="form-control" name="searchfromdate"  placeholder="" id="searchfromdate" ng-model="searchfromdate" uib-datepicker-popup="dd-MMM-yyyy" is-open="opened.opened2" ng-click="doubleopen($event,'opened2')"  datepicker-options="assDate1" required="" > 
																<div class="error" data-ng-show="submitted || AddCategoryForm.searchfromdate.$dirty && AddCategoryForm.searchfromdate.$invalid">
																	<small class="error" data-ng-show="AddCategoryForm.searchfromdate.$error.required">Dis From Date is required.</small>
																</div>
														</div>
													</div>
												</div>
												...
												<div class="col-md-6" ng-show="searchtype=='From & To Date'">
													<div class="form-group">
														<label class="col-sm-4 control-label no-padding-right" for="Dis To Dt"> Dis To Dt</label>
														
														<div class="col-sm-8">
															<input type="text" class="form-control" name="searchtodate"  placeholder="" id="searchtodate" ng-model="searchtodate" uib-datepicker-popup="dd-MMM-yyyy" is-open="opened.opened3" ng-click="tribleopen($event,'opened3')"  datepicker-options="assDate2" required="" > 
																<div class="error" data-ng-show="submitted || AddCategoryForm.searchtodate.$dirty && AddCategoryForm.searchtodate.$invalid">
																	<small class="error" data-ng-show="AddCategoryForm.searchtodate.$error.required">Dis To Date is required.</small>
																</div>
														</div>
													</div>
												</div>
