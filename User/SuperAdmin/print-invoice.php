...
else
{
	if($_REQUEST['Id']!="")
	{
		$Id = $_REQUEST['Id'];
			...
			$query11 = $dbConnection->prepare("SELECT DisplayName,EmailId,Mobile FROM CustomerMaster WHERE CustomerId=?");
							...
							<div class="widget-box transparent">
								<div class="widget-header widget-header-large">
									...
									<div class="widget-toolbar no-border invoice-info">
										...
										<span class="red">#<?php echo $InvoiceId;?></span>

										<br>
										<span class="invoice-info-label">Invoice Date:</span>
										<span class="blue"><?php echo date('d M y', strtotime($InvoiceDate));?></span>
										<br>
										<span class="invoice-info-label">Due Date:</span>
										<span class="blue"><?php echo date('d M y', strtotime($DueDate));?></span>
									</div>
									...
									<div class="widget-main padding-24">
										...
										<div class="row">
											<div class="col-sm-5 pull-right">
												...
												<h4 class="pull-right">
													Total amount :
													<span class="red"> <i class="ace-icon fa fa-inr red"></i> <?php echo $InvoiceTotal;?></span>
												</h4>
											</div>
