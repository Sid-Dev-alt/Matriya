...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/add-new-invoice-script.js"></script>
	</head>

	<body class="no-skin" data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" ng-init="GetGrnId();GetPurchaseBars();GetCustomers()">
