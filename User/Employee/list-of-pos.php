...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/PO-script.js"></script>
	</head>
									...
									<table id="dynamic-table" class="table table-bordered table-striped table-condensed cf"  datatable="ng" dt-options="vm.dtOptions" dt-column-defs="vm.dtColumnDefs">
										...
										<tbody >
											<tr  ng-repeat="cat in pagedItems">
												...
												<td data-title="Date">{{cat.POrderDate | date: 'd MMM y'}}</td>
												<td data-title="Sales Order">{{cat.POrderId}}</td>
												<td data-title="Reference">
													{{cat.Reference}}
													<p ng-if="cat.Reference==undefined">&nbsp;</p>
												</td>
												<td data-title="Vendor Name">{{cat.VendorName}}</td>
												<td data-title="PO Status">
													<span class="label label-info arrowed" ng-if="cat.POStatus=='1'">Draft</span>
													<span class="label label-info arrowed" ng-if="cat.POStatus=='2'">Sent</span>
													<span class="label label-info arrowed" ng-if="cat.POStatus=='3'">Received</span>
													<div class="clearfix">&nbsp;</div>
													<a href="receive-po.php?Id={{cat.PkId}}">
														<span class="label label-warning arrowed" ng-if="cat.POStatus!='3'">Mark as Received</span>
													</a>
												</td>
												<td data-title="Action">
													<!-- <a href="open-po.php?Id={{cat.PkId}}"  class="btn btn-xs btn-inverse">OPEN &nbsp;
														<i class="ace-icon fa fa-eye bigger-120"></i>
													</a>&nbsp; -->

													<a ng-if="cat.POStatus=='3'" href="" ng-click="EditOrder(cat.PkId,cat.VendorId_VendorMaster,cat.VendorName,cat.POrderId,cat.POrderDate,cat.Reference,cat.DeliveryDate,cat.PaymentTerms,cat.ShipmentReference,cat.CustomerNotes,cat.TermsCondition,cat.SubTotal,cat.DiscType,cat.DiscountVal,cat.DiscountAmount,cat.AdditionalCharges,cat.OrderTotal,cat.POStatus,cat.FileName,cat.data2)"  class="btn btn-xs btn-info">EDIT &nbsp;
														<i class="ace-icon fa fa-pencil bigger-120"></i>
													</a>&nbsp;

													<a href="print-po.php?Id={{cat.PkId}}" target="_blank" class="btn btn-xs btn-inverse" >Print &nbsp;
														<i class="ace-icon fa fa-print bigger-120"></i>
													</a>&nbsp;

													<!-- <a href="" ng-click="DeletePO(cat.PkId,cat.POrderId)" class="btn btn-xs btn-danger" >Delete &nbsp;
					...
					<div ng-show="FormAdd" >
						<div class="row">
							<div class="col-xs-12">
								 <form class="form-horizontal" role="form" id="AddCategoryForm" name="AddCategoryForm" autocomplete="off" enctype="multipart/form-data" novalidate="" data-ng-submit="AddCategoryData()">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" id="salesorder" placeholder="" class="form-control" name="POrderId" required  data-ng-model="POrderId" disabled="">
									...
									<div class="col-sm-6">
										...
										<input type="text" id="vendorname" placeholder="" class="form-control" name="vendorname" required   data-ng-model="vendorname"  uib-typeahead="cust as cust.DisplayName for cust in VendorArray | filter:$viewValue" typeahead-editable="false" typeahead-on-select="onVendorSelect($item, $model, $label)">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
										<input type="text" class="form-control" name="entrydate"  placeholder="" id="entrydate" ng-model="entrydate" uib-datepicker-popup="dd-MMM-yyyy" is-open="opened.opened1" ng-click="singleopen($event,'opened1')"  datepicker-options="assDate1" required="" ng-disabled="pagetitle=='Edit Purchase Order'"> 
									...
									<div class="form-group" style="display: none">
										<label class="col-sm-3 control-label no-padding-right" for="reason">Expected Delivery Date </label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="State">Shipment Reference </label>
										<div class="col-sm-6">
									...
									<div class="clearfix"></div>
									 <div class="form-group">
										...
										<div class="col-sm-6">
		                              	...
		                              	<div class="clearfix">&nbsp;</div>
		                              	<span ng-if="FileName!=undefined"><a href="../POImages/{{FileName}}" target="_blank">{{FileName}}</a></span>
		                              	</div>
									</div>
									...
									<thead>
										<tr>
											...
											<th>Rate</th>
											<th>Amount</th>
											<th ng-if="pagetitle=='Add Raw Purchase'">ACTION</th>
										</tr>
									</thead>
									<tbody>
										<tr ng-repeat="bat in BatchArr">
											...
											<div class="form-group">
												<div class="col-sm-12">
													...
													<input type="hidden" value="{{bat.OldProductId}}">
												...
												<p ng-if="bat.ProductId!=undefined" style="display: none">Available Quantity: {{bat.AvlQty}}</p>
											...
											<td data-title="Qty" class="center">
												<div class="form-group">
													<input type="hidden" value="{{bat.Oldquantity}}">
												<div class="col-sm-12" ng-if="bat.InventoryType=='Raw'">
												...
												<div class="col-sm-12" ng-if="bat.InventoryType=='Finished'">
											...
											<td data-title="ACTION" ng-if="pagetitle=='Add Raw Purchase'">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">&nbsp;</div>
								<div class="col-sm-2">
									<input  type="text" name="additionalcharges" class="form-control"  ng-model="additionalcharges" valid-number="" allow-decimal="false" allow-negative="false" ng-change="getDiscAmt(sum,disctype,discvalue,additionalcharges)">	
							...
							<div class="form-group">
								...
								<div class="col-sm-1">
									<input  type="text" name="discvalue" class="form-control"  ng-model="discvalue" valid-number="" allow-decimal="false" allow-negative="false" ng-change="getDiscAmt(sum,disctype,discvalue,additionalcharges)">	
							...
							<div class="modal-content">
								...
								<div class="row">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input class="form-control" type="tel" id="mobileno1" name="billmobileno" maxlength="10" required placeholder="" data-ng-model="billmobileno" data-ng-minlength="10" data-ng-maxlength="10" pattern="[6-9]{1}[0-9]{9}"> 
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="Address">Address Lane1<span class="error">*</span></label>
										<div class="col-sm-6">
											<textarea  name="shipaddress1" id="shipaddress1" class="form-control" ng-model="shipaddress1" placeholder="" required="" ></textarea>
