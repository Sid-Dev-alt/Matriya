...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/category-script.js"></script>
	</head>
						...
						<div class="row" >
							<div class="col-xs-12 page-header">
		                  	 <div class="col-xs-8 col-sm-8 col-lg-9">
								<!-- <div class="btn-group" ng-if="FormList">
									<select class="btn-group" name="location" required="" data-ng-model="location" ng-change="GetListData(location)">
								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="dd" id="nestable">
											<ol class="dd-list">
												<li class="dd-item dd2-item" data-id="1"  ng-repeat="cat in pagedItems">
												<!-- data-ng-click="EditCat(cat.PkId,cat.CategoryName,cat.CategoryDescription)" -->
													<a class="red" href="" >
														<div class="dd-handle">
													...
													<!-- <div class="dd-handle dd2-handle">
														<a href="" ng-click="Delete(cat.PkId)" title="Delete"><i class="normal-icon ace-icon fa fa-trash red bigger-130"></i>
														</a>
													</div> -->
												</li>
											</ol>
										...
										<tbody >
											<tr  ng-repeat="cat in pagedItems">
												...
												<td data-title="Action">
													<button type="button" class="btn btn-xs btn-info" data-ng-click="EditCat(cat.PkId,cat.CategoryName,cat.CategoryDescription)">Edit &nbsp;
								...
								<!-- PAGE CONTENT BEGINS -->
								 <form class="form-horizontal" role="form" id="AddCategoryForm" name="AddCategoryForm" autocomplete="off" enctype="multipart/form-data" novalidate="" data-ng-submit="AddCategoryData()">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="catname" placeholder="" class="col-xs-10 col-sm-5" name="catname" required  autofocus data-ng-model="catname" data-ng-minlength="3" ng-change="checkCatgory(FormPkId,catname)">
												<div class="error" data-ng-show="submitted || AddCategoryForm.catname.$dirty && AddCategoryForm.catname.$invalid">
													...
													<small class="error" data-ng-show="AddCategoryForm.catname.$error.minlength">Category Name is required to be at least 3 characters</small>
													<small class="error" data-ng-show="AddCategoryForm.catname.$error.pattern">Category Name should be alphabets ex:abcd</small>
