...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/search-raw-purchase-script.js"></script>
    	<style type="text/css">
    		.new-row {
  clear: left;
}
	...
	<body class="no-skin" data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" data-ng-init="GetListData();LoadProducts()">
							...
							<div class="row">
								<div class="col-md-12">
										<form class="form-horizontal" role="form" id="AddCategoryForm" name="AddCategoryForm" autocomplete="off" enctype="multipart/form-data" novalidate="">
											...
											<div class="row">
												<div class="col-md-6" ng-show="searchtype=='PO Id'">
													<div class="form-group">
														<label class="col-sm-4 control-label no-padding-right" for="PO Id"> PO Id </label>
														
														<div class="col-sm-8">
															<input type="text" id="salesorder" placeholder="" class="form-control" name="searchpoid" required  data-ng-model="searchpoid">
																<div class="error" data-ng-show="submitted || AddCategoryForm.searchslitid.$dirty && AddCategoryForm.searchslitid.$invalid">
																	<small class="error" data-ng-show="AddCategoryForm.searchslitid.$error.required">PO Id is required.</small>
																</div>
														</div>
													</div>
												</div>
												...
												<div class="col-md-6" ng-show="searchtype=='From & To Date'">
													<div class="form-group">
														<label class="col-sm-4 control-label no-padding-right" for="PO From Dt"> PO From Dt </label>
												...
												<div class="col-md-6" ng-show="searchtype=='From & To Date'">
													<div class="form-group">
														<label class="col-sm-4 control-label no-padding-right" for="PO To Dt"> PO To Dt</label>
