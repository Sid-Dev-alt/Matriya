...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/company-profile-script.js"></script>
	</head>

	<body class="no-skin"  data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" ng-init="GetStates();GetCompanyInfo()">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								 <form class="form-horizontal" role="form" id="AddCustomerForm" name="AddCustomerForm" autocomplete="off" enctype="multipart/form-data" novalidate="" data-ng-submit="AddCustomerData()">	
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="industrytype">Business Type </label>
										<div class="col-sm-6">
											<input type="text"  name="businesstype" class="form-control"   uib-typeahead="ind as ind for ind in BusinessArray | filter:$viewValue" ng-model="businesstype" >
											<div class="error" data-ng-show="submitted || AddCustomerForm.businesstype.$dirty && AddCustomerForm.businesstype.$invalid">
											<small class="error" data-ng-show="AddCustomerForm.businesstype.$error.required">Business Type Required</small>
											</div>
										</div>
									</div>
									...
									<div class="clearfix"></div>
									 <div class="form-group">
									  	<label class="col-sm-3 control-label no-padding-right" for="PinCode">
									  		<span ng-if="LogoFilename==undefined">Upload</span>
									  		<span ng-if="LogoFilename!=undefined || LogoFilename!=''">Replace</span>
									  		 Logo File 
									  	</label>
										...
										<div class="col-sm-6">
		                              	...
		                              	<p>&nbsp;</p>
		                              	<img src="../CompanyLogo/{{LogoFilename}}">
		                              	</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="GSTIN"> GSTIN No </label>
										<div class="col-sm-6">
											<input class="form-control"  placeholder="" name="gstin" ng-model="gstin" maxlength="15">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text"  name="state" class="form-control"   uib-typeahead="st as st for st in StateArray | filter:$viewValue" typeahead-editable="false" typeahead-on-select="onCSelect($item, $model, $label)" ng-model="state" required="" >
