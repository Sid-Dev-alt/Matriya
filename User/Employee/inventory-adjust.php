...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/inventory-adjust-script.js"></script>
	</head>
									...
									<table id="dynamic-table" class="table table-bordered table-striped table-condensed cf"  datatable="ng" dt-options="vm.dtOptions">
										...
										<tbody >
											<tr  ng-repeat="cat in pagedItems">
												...
												<td data-title="Available Quantity">
												{{cat.AvlQty}}
												</td>
												<td data-title="Action">
													<button type="button" class="btn btn-xs btn-info" data-ng-click="EditCat(cat.PkId,cat.ProductId,cat.ProductName,cat.TrackingMode,cat.AvlQty,cat.data2)">Manage &nbsp;
								...
								<div class="form-group" ng-if="TrackingMode=='None'">
									...
									<tbody>
										<tr ng-repeat="oldbat in BatchArr">
											...
											<div class="form-group">
												<div class="col-sm-12">
													<input type="hidden" value="{{oldbat.InvPkId}}">
