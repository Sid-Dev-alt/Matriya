...
{		
	...
	{				
			...
			header("Content-Disposition: attachment; filename=Finished-products-info.xls"); # filename
?>
<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="http://www.w3.org/TR/REC-html40">
	<?php
			
			print "<table border='0'><tr><td valign='top' align='center' colspan='2'><strong>Account of Finished Products</strong></td></tr>
	<tr>
	<td valign='top' align='left'><strong>Product</strong></td>
	<td valign='top' align='left'><strong>Available Qty</strong></td>
	</tr>
";
			$i=1;
...
$i++;
		...
		{			
			echo "<script language=javascript>window.location=\"finished-product-list.php\";alert(\"No Records Found.\");</script>";
		}
	// }
	// else
	// {
