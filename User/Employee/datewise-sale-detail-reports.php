...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/datewise-sale-detail-report-script.js"></script>
	</head>
								...
								<div class="col-xs-12">
									...
									<div class="row">
										...
										<table id="dynamic-table" class="table table-bordered table-striped table-condensed cf">
											<thead class="cf">
												<tr>
													<th ng-click="sort('Id')">Bill Id <span class="glyphicon sort-icon" ng-show="sortKey=='Id'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span></th>
													<th ng-click="sort('Date')">Bill Date <span class="glyphicon sort-icon" ng-show="sortKey=='Date'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span></th>
													<th ng-click="sort('Customer')">Customer Name <span class="glyphicon sort-icon" ng-show="sortKey=='Customer'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span></th>
											...
											<tbody >
												...
												<tr dir-paginate="cat in pagedItems|orderBy:sortKey:reverse|filter:search|itemsPerPage:10" total-items="{{total_count}}" current-page="mypageno">
													...
													<td data-title="Remarks"><p class="pre-data">{{cat.Remarks}}</p></td>
												</tr>
