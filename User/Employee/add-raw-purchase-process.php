...
{		
	...
	if(in_array('1', $Qtychk))
	{
		...
		if($check==0)
		{
			...
			$query1 = $dbConnection->prepare("INSERT INTO RawPurchaseMaster (RawPurchaseId,RawPODate,VendorId_VendorMaster,CreatedTime) VALUES (?,?,?,?)");
			$query1->execute(array($POrderId,$entrydate,$VendorId,$DATEIME));
