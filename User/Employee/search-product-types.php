...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/search-product-type-script.js"></script>
	</head>

	<body class="no-skin" data-ng-cloak data-ng-app="CategoryModule" data-ng-controller="CategoryController" data-ng-init="LoadCatgory();GetProducts();">
							...
							<div class="row" ng-show="FormList">
								<div class="col-md-12">
									<form class="form-horizontal" role="form" id="AddCategoryForm" name="AddCategoryForm" autocomplete="off" enctype="multipart/form-data" novalidate="">
										...
										<div class="row">
											<div class="col-md-6" ng-show="searchtype=='Micron'">
												<div class="form-group">
													<label class="col-sm-4 control-label no-padding-right" for="Micron"> Micron </label>
													
													<div class="col-sm-8">
														<input type="text" id="salesorder" placeholder="" class="form-control" name="searchmicron" required  data-ng-model="searchmicron">
										...
										<tbody>
											<tr dir-paginate="cat in pagedItems|orderBy:sortKey:reverse|filter:search|itemsPerPage:10" total-items="{{total_count}}" current-page="mypageno">
												...
												<tr ng-repeat="sp in cat.data2|orderBy:sortKey1:reverse1">
													...
													<td>{{sp.Quantity}}</td>
													<td><a target="_blank" href="generate-inv-barcode.php?Id={{sp.InvPkId}}&Page=Item" target="_blank" class="btn btn-xs btn-danger" >Print &nbsp;
