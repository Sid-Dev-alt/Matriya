...
$scope.getData = function(pageno){ 
    ...
    // This would fetch the data on page change.
        ...
        $scope.pagedItems = [];  
        $scope.loading = true;
        $http.post("load-search-product-types.php",{'itemsPerPage': $scope.itemsPerPage, 'pagenumber': pageno,'searchmicron': $scope.searchmicron,'itemname':$scope.itemname.ProductId})
          .then(function successCallback(response)
        {
            var data = response.data;
