...
<html lang="en">
	<head>
    	...
    	<script src="angularjs/sub-category-level2-script.js"></script>
	</head>
								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="dd" id="nestable">
											<ol class="dd-list">
												<li class="dd-item " ng-class="{'dd-collapsed' : $index!='0'}" data-id="{{cat.PkId}}" ng-repeat="cat in Levle2Arr">
													...
													<ol class="dd-list" >
														<li class="dd-item" ng-repeat="subcat in cat.data2"  data-id="{{subcat.SubPkId}}">
															...
															<div class="dd-handle   btn-light no-hover">{{subcat.SubCategoryName}}
																<div class="pull-right action-buttons">
																	<a class="red" href="" data-ng-click="AddLevel2Cat(cat.PkId,cat.CategoryName,subcat.SubPkId,subcat.SubCategoryName)">
															...
															<ol class="dd-list" >
															<li class="dd-item item-red" ng-repeat="lvl2 in subcat.data3"  data-id="{{lvl2.PkId}}" >

																<a class="red" href="" data-ng-click="EditLevel2Cat(lvl2.Level2PkId,lvl2.Level2SCName,cat.PkId,cat.CategoryName,subcat.SubPkId,subcat.SubCategoryName)">
																	<div class="dd-handle"><i class="primary ace-icon fa fa-pencil bigger-130"></i>&nbsp;&nbsp;
																		{{lvl2.Level2SCName}}
																	<div class="pull-right action-buttons">
																...
																<a href="" ng-click="Delete(lvl2.Level2PkId)" title="Delete"><i class="normal-icon ace-icon fa fa-trash red bigger-130"></i>
																</a>
																</div>
															</li>
														</ol>
								...
								<!-- PAGE CONTENT BEGINS -->
								 <form class="form-horizontal" role="form" id="AddCategoryForm" name="AddCategoryForm" autocomplete="off" enctype="multipart/form-data" novalidate="" data-ng-submit="AddCategoryData()">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="lvl2subcatname" placeholder="" class="col-xs-10 col-sm-5" name="lvl2subcatname" required  autofocus data-ng-model="lvl2subcatname" data-ng-minlength="3" ng-change="checkCatgory(FormPkId,CatId,SubcatId,lvl2subcatname)">
												<div class="error" data-ng-show="submitted || AddCategoryForm.lvl2subcatname.$dirty && AddCategoryForm.lvl2subcatname.$invalid">
													...
													<small class="error" data-ng-show="AddCategoryForm.lvl2subcatname.$error.minlength">Name is required to be at least 3 characters</small>
													<small class="error" data-ng-show="AddCategoryForm.lvl2subcatname.$error.pattern">Name should be alphabets ex:abcd</small>
