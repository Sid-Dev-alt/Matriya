...
<html>
	<head>
        ...
        <link rel="stylesheet" href="../../assets/css/sample-test.css">    
       ...
       <div class="container">
       	<div class="row">
       	    <div class="col-md-offset-3 col-md-9">
       	        <p class="gap">&nbsp;</p>
       	        <p class="gap">&nbsp;</p>
				<a class="btn btn-info" href="#" onclick="window.print();"><i class="ace-icon fa fa-check bigger-110"></i> PRINT</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-inverse" href="slitting.php"><i class="ace-icon fa fa-close bigger-110"></i> BACK TO LIST</a>
			</div>
